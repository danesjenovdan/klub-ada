...
export const linkBase = tv({
  variants: {
    variant: {
      primary:
        "text-sm font-medium text-white select-none outline-none whitespace-nowrap",
      secondary:
        "text-md font-medium text-white select-none outline-none whitespace-nowrap",
      tertiary:
        "text-lg font-medium text-white select-none outline-none whitespace-nowrap",
    },
  },
});
