...
export function ImageStat({ src, label, stat }: ImageStatProps) {
  return (
    <div className="relative w-full min-h-[200px] min-w-[400px] md:max-w-[400px] md:min-h-[400px] rounded-lg">
      <Image
        src={src}
      ...
      <div className="flex flex-col absolute w-full h-full top-0 left-0 items-center justify-center">
        <Heading
          color="red"
          className="font-paragraph text-8xl md:text-8xl lg:text-8xl"
          size="lg"
        >
          {stat}
        </Heading>
